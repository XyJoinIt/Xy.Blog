...
namespace Xy.Project.Platform.Model.Migrations
{
    ...
    [Migration("20221211052316_v1.0.8")]
    partial class v108
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SysRoleSysUser", b =>
                {
                    b.HasOne("Xy.Project.Platform.Model.Entities.Sys.SysRole", null)
                        .WithMany()
                        .HasForeignKey("RolesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Xy.Project.Platform.Model.Entities.Sys.SysUser", null)
                        .WithMany()
